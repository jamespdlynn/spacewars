    ...
    extend.call(Sprite.prototype, {
        ...
        updateData : function(deltaSeconds){
            ...
            if (data.acceleration > 0){
                ...
                if (deltaAcceleration > data.acceleration){

                    var deltaSeconds1 = data.acceleration / this.jerk;
                    ...
                    var deltaVelocity = (data.acceleration*deltaSeconds) + (this.jerk * s2 / 2);

                    deltaPosition = (data.velocity * deltaSeconds) + (data.acceleration * s2 / 2) * (this.jerk * s3 / 6);

                    data.velocity += deltaVelocity;
