define(["binaryjs","microjs","model/schemas","model/constants","socket/zone"], function(binary, micro, schemas,Constants,ServerZone){
    ...
    function onConnection(connection){
        ...
        var initializeZone = function(){
            ...
            if (availableWorldSize < Constants.MAX_WORLD_SIZE && connectionCount >= (availableWorldSize*availableWorldSize*1.5)){
                availableWorldSize++;
                console.log(availableWorldSize);
            }
        ...
        connection.on("close", function(){
            ...
            if (availableWorldSize > Constants.MIN_WORLD_SIZE && connectionCount < (availableWorldSize*availableWorldSize)){
                availableWorldSize--;
