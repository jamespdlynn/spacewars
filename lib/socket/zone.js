        ...
        updatePlayer : function(dataObj){
            ...
            if (player){
                ...
                if (player.hasChanged()){
                    if (player.hasChanged("isAccelerating")){
                        player.update().accelerate()
                        this._sendPlayer(player, 12);
                    }else{
                ...
                if (dataObj.isFiring && player.canFire()){
                    var missile = this.model.missiles.add(player.update().fireMissile());
