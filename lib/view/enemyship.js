define(['createjs','view/starship'],function(createjs,StarShip){
    ...
    var EnemyShip = function (model){
        ...
        this.nameLabel = new createjs.Text(model.get("username"),"bold 20px SpaceRanger", "#fff");
    ...
    extend.call(EnemyShip.prototype, {
        ...
        initialize : function(){
            ...
            var labelHeight = this.nameLabel.getMeasuredLineHeight();

            this.nameLabel.x = -labelWidth/2;
            this.nameLabel.y = (height/2)+labelHeight;
            this.nameLabel.alpha = 0.6;
            this.nameLabel.cache(0, 0, labelWidth, labelHeight);
