define(['createjs','model/constants','model/game'],function(createjs, Constants,gameData){
    ...
    extend.call(StarShip.prototype, {
        ...
        initialize : function(){
            ...
            this.flame1 = new createjs.Sprite(spriteData, "play");
            this.flame1.x = 0;
            this.flame1.y = (height/2)-12.5;

            this.flame2 = new createjs.Sprite(spriteData, "play");
            this.flame2.x = -20;
        ...
        _tick : function(evt){
            ...
            this.flame1.visible = this.flame2.visible = this.hasOwnProperty('isAccelerating') ? this.isAccelerating : data.isAccelerating;
