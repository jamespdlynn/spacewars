define(['createjs','view/gauge','model/constants','model/game'],function(createjs, FuelGauge, Constants,gameData){
    ...
    var UserContainer = function (){
        this.usernameLabel = new createjs.Text("","20px SpaceRanger", "#fff");
        this.deathLabel = new createjs.Text("","bold 20px Helvetica", "#fff");
        this.killLabel =  new createjs.Text("","bold 20px Helvetica", "#fff");
