define(['createjs','view/starship','model/constants'],function(createjs,StarShip,Constants){
    ...
    var FUEL_PER_TICK = Constants.Player.fuelPerSecond/Constants.FPS;
    ...
    (function(){
        ...
        this.shape.setTransform(33.4,45.5,0.188,0.188);
        ...
        this.shape_1.setTransform(33.4,45.5,0.188,0.188);
        ...
        this.shape_2.setTransform(39.8,45.5,0.188,0.188);
        ...
        this.shape_3.setTransform(39.8,45.5,0.188,0.188);
        ...
        this.shape_4.setTransform(18.6,36.5,0.188,0.188);
        ...
        this.shape_5.setTransform(18.6,36.5,0.188,0.188);
        ...
        this.shape_6.setTransform(54.6,36.5,0.188,0.188);
        ...
        this.shape_15.setTransform(65.9,47,0.188,0.188);
        ...
        this.shape_16.setTransform(47.1,60.1,0.188,0.188);
        ...
        this.shape_17.setTransform(47.1,60.2,0.188,0.188);
        ...
        this.shape_18.setTransform(26.1,60.1,0.188,0.188);
        ...
        this.shape_19.setTransform(26.1,60.2,0.188,0.188);
    ...
    var UserShip = function (model){
        ...
        this.exhaustSprites = preloader.getResult("blueExhaustSprites");
    ...
    extend.call(UserShip.prototype, {
        ...
        _tick : function(evt){
            ...
            if (this.isAccelerating){
                ...
                this.fuel = Math.min((this.fuel+FUEL_PER_TICK/2), 100);
            }
