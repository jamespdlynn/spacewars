define(["microjs","models/zone","models/constants"], function(micro, Zone, Constants){
    'use strict';
    ...
    extend.call(ServerZone.prototype, {
        ...
        toggleUpdateInterval : function(){
            ...
            if (!this._updateInteval && numSprites){
                this._updateInteval = setInterval(this.detectAllCollisions.bind(this), Constants.COLLISION_DETECT_INTERVAL);
            }
